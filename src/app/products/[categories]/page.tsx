...
import Filterzin from "../../../assets/filter-ordered.png";
import CardProducts from "@/src/components/CardProducts";
import { getProducts } from "@/src/services/api";

export default async function Categories({ params }: { params: { categories: string } }) {
    // const {
    //     handleChangePrice,
    //     handleChangeColor,
    //     handleChangeStorage,
    ...
    return (
        <Container>
            <p>
                <strong>Você está em: </strong>{param}
            </p>
            <div>
                <div>
                    ...
                    <p>Acessórios</p>
                    <div>
                        <Image src={Filterzin} alt="Ícone filtrar" />
                        <h3>Filtrar por:</h3>
                    </div>
                    <div>
                        <h4>Preço</h4>
